       ...
       77 a-func     pic X(7).
       77 a-val      pic 9.
       77 a-horizont pic S9(4) comp-4 value zero.
       77 a-depth    pic S9(4) comp-4 value zero.
       77 a-key      pic S9(8) comp-4.
       ...
       procedure division.
           ...
           perform until eof-in
              ...
              evaluate a-func
                 when 'forward' add a-val to   a-horizont
                 when 'down'    add a-val to   a-depth
                 when 'up' subtract a-val from a-depth
              end-evaluate
              read input-file at end set eof-in to true end-read
           end-perform
           display a-horizont
