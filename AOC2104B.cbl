      ...
      *B*
       77 board-count  pic S9(4) comp value 1.
       77 winner-count pic S9(4) comp value zero.

       01 filler.
          05 winner-boards pic X(100) value all 'L'.
          05 filler redefines winner-boards.
             10 winner-board pic X occurs 100 times indexed by wbx.
                88 winner value 'W'.
      ...
      * Draw numbers:
           ...
           perform draw until dn-point > length of dn-string
                           ...
                           or winner-count >= board-count

      * Sum all unmarked numbers on last winning board
      ...
      * Check column for bingo:
                    if 'X' = marker(bbx, 1, bnx)
                       ...
                       set wbx to bbx
                       if not winner(wbx) *> Do not count twice
                          add 1 to winner-count
                       end-if
                       set winner(wbx) to true
                    end-if
                 end-perform
      * Check row for bingo:
